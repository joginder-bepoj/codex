      ...
      <div className="row">
        <div className="col-md-8 wow fadeInLeft">
          <h2 className="sub-heading mb-4">About Codex View</h2>
            <p>
                Codex View is designed to help beginner programmers who want to learn web development, And Web Designing technologies,
                or start a career in website development. Codex View is a leading online tutorials education portal that helps technologies,
                software, business and creative skills readers to learn new skills at their own place from the comforts of their drawing 
                rooms. Individual, corporate and academic members have access to learn anything on tutorialswebsite.com likes video 
                tutorials, blogs content etc.
            </p>
            <p>
